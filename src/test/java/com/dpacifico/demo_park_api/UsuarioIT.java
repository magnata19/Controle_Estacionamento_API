...
public class UsuarioIT {
    ...
    public void createUsuario_ComUsernameRepetido_RetornarErrorMessage409(){
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("davids@david2.com", "123321"))
                .exchange()
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("davids@david2.com");
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("pacific@david2.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.getRole()).isEqualTo("CLIENTE");
    ...
    public void editarSenha_ComDadosValidos_RetornarStatus204() {
        testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthentication(testClient,"davids@david2.com","123321"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("123321","123321","123321"))
                .exchange()
    ...
    @Test
    public void editarSenha_ComDadosInvalidos_RetornarErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .headers(JwtAuthentication.getHeaderAuthentication(testClient,"davids@david2.com","123321"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("123321", "123456", "000000"))
                .exchange()
        ...
        responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthentication(testClient,"davids@david2.com","123321"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("123321","000000","123456"))
                .exchange()
                .expectStatus().isEqualTo(400)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void editarSenha_ComUsuariosDiferentes_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios/0")
                .headers(JwtAuthentication.getHeaderAuthentication(testClient,"davids@david2.com","123321"))
                .bodyValue(new UsuarioSenhaDto("123321", "123456", "123456"))
                .exchange()
                .expectStatus().isForbidden()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void listarUsuarios_SemQualquerParametro_RetornarListaDeUsuariosComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.size()).isNotZero();
