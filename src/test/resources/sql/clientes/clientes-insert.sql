...
insert into CLIENTES (id, nome, cpf, id_usuario) values (10, 'davids@email.com', '19796804859', 101);
insert into CLIENTES (id, nome, cpf, id_usuario) values (20, 'pacifico@email.com', '92476215007', 102);